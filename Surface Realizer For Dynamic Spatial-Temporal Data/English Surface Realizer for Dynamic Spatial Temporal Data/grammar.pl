%:- multifile verb_phrase_with_object_phrase_preposition/3.
%:- multifile preposition_object_noun_phrase_2/3.
%:- multifile complete_object_phrase/3.
%:- multifile complete_verb_object_phrase/3.
%:- multifile complete_verb_object_phrase/3.
%:- multifile final/3.
